...
| ID | 초기 심각도 | 초기 문제 | 상태 |
|---|---|---|---|
| CAR-AUD-001 | P1 | 200% 확대에서 입력·세금 결과·세부 표가 한 글자 열로 붕괴합니다. | resolved |
| CAR-AUD-002 | P1 | 차량가액 text input과 range에 연결된 label이 없습니다. | resolved |
| CAR-AUD-003 | P2 | 주 탭 대비가 2.55:1~2.78:1이고 선택 버튼 일부가 3.65:1입니다. | resolved |
| CAR-AUD-004 | P2 | 12px 미만 텍스트 최대 25개와 소스 tiny 패턴 21개가 확인됩니다. | resolved |
| CAR-AUD-005 | P2 | NotFound 화면에 h1이 없습니다. | resolved |
...
- 현재: client/src/data/seoGuides.ts 460줄, client/src/assets/css/main.css 436줄, client/src/views/EvVsGasView.vue 381줄, client/src/lib/validators.ts 306줄
