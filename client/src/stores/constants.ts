...
import { CAR_TAX_DATA_UPDATED, CAR_TAX_DATA_VERIFIED } from "@/data/carTaxRates";
...
const fallbackConstants: PublicConstants = {
  ...
  feeDataUpdated: [CAR_TAX_DATA_UPDATED, INSURANCE_DATA_UPDATED, LEASE_DATA_UPDATED]
    .sort()
    .at(-1) ?? CAR_TAX_DATA_UPDATED,
  feeDataVerified: CAR_TAX_DATA_VERIFIED,
